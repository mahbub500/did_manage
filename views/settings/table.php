...
$config = [
	...
	'columns'		=> [
		'id'				=> __( 'Order #', 'wp-did' ),
		'products'			=> __( 'Products', 'wp-did' ),
		'order_total'		=> __( 'Order Total', 'wp-did' ),
		'commission'		=> __( 'Commission', 'wp-did' ),
		'payment_status'	=> __( 'Payment Status', 'wp-did' ),
		'time'				=> __( 'Time', 'wp-did' ),
	],
	...
	'bulk_actions'	=> [
		'delete'	=> __( 'Delete', 'wp-did' ),
		'draft'		=> __( 'Draft', 'wp-did' ),
	],
];
